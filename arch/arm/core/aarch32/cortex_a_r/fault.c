...
#if DBG_PRINT == 1
	#define printk_dbg(val) (sys_write32((unsigned int)(val), 0xE0001030))
	#define print_uint32(num) { \
...
#else
	#define printk_dbg(val)
	#define print_uint32(number)
#endif
